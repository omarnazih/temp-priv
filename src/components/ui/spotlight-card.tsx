...
const SpotlightCard = ({
  ...
  const getSpotlightBackground = (pos: { x: number; y: number }, size: number, blur = false) => {
  ...
  //   theme === 'light' && lightGradientColor ? lightGradientColor : gradientColor;
  ...
  return (
    <div
      ...
      className={cn(
        'relative w-full overflow-hidden shadow-sm rounded-xl bg-background transition-transform duration-300',
    ...
    >
      ...
      <div
        ...
        style={
          {
            opacity,
            background: getSpotlightBackground(position, spotlightSize, spotlightBlur),
